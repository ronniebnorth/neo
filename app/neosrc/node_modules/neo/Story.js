...
var self = module.exports = class Story {
  ...
  newStory() {
    ...
    newStory.logEvent('created', {fromTemplate: this.metadata});
  ...
  logEvent(eventName, data) {
    this.jpf.updateChunk('log', logChunk => {
      if (!('logArray' in logChunk)) {
        logChunk.logArray = [];
      }

      logChunk.logArray.push({eventName, timestamp: new Date(), data});
    });
  }
